...
function BuscarReportes(event) {
    ...
    let url = `/buscar_reportes?correo_usuario=${correo_usuario}&lugar=${lugar}&item=${item}&tipo=${Tipo}&estado=${Estado}&orden=${AntiguoReciente}&retroalimentacion=${Retroalimentacion}`;
